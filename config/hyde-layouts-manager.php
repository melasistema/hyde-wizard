    ...
    */
    'layouts' => [
        ...
        'melasistema' => [
            ...
            'navigation' => [
                'brand' => [
                    'type' => 'image', // accepted values: "image" "text" "custom"
                    'url' => '/',
                    'lightLogo'  => 'media/logo/logo-navigation-light.png',
                    'darkLogo'  => 'media/logo/logo-navigation-dark.png',
                    'logoHeight' => 'h-10',
                ],
                'cta' => [
                    'text' => 'Buy Book',
            ...
            'footer' => [
                ...
                'default' => [
                    ...
                    'description' => 'Zoe’s magical doodles',
                    'links' => [
                        [
                            'title' => 'Buy Book',
                            'url' => 'https://github.com/melasistema/hydephp-layouts-manager',
        ...
        'hero' => [
            ...
            'default' => [
                ...
                'settings' => [
                    ...
                    // Heading text sizes for different screen sizes
                    'headingTextSize' => [
                        'default' => 'text-3xl', // For default screens
                        'md' => 'md:text-6xl',   // For medium screens
                        'lg' => 'lg:text-8xl',   // For large screens
                    ],
                    // Subheading text sizes for different screen sizes
                    'subHeadingTextSize' => [
                        'default' => 'text-lg',  // For default screens
                        'md' => 'md:text-xl',    // For medium screens
                    ],
                    // Button text sizes for different screen sizes
                    'buttonTextSize' => [
                        'default' => 'text-base', // For default screens
                        'sm' => 'sm:text-lg',     // For small screens
                    ],
